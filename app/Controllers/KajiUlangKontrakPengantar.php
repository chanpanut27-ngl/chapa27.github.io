...
class KajiUlangKontrakPengantar extends ResourceController
{
    ...
    {   
        ...
        return view('Backend/Modul/Pelayanan/Lab/Kaji-ulang-kontrak/index', $data);
    }
    ...
    public function list()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('Backend/Modul/Pelayanan/Lab/Kaji-ulang-kontrak/__data', $data)
            ];
    ...
    public function new()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('Backend/Modul/Pelayanan/Lab/Kaji-ulang-kontrak/__add', $data)
            ];
    ...
    public function edit($id = null)
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => view('Backend/Modul/Pelayanan/Lab/Kaji-ulang-kontrak/__edit', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('Not Process');
