...
class KeteranganPengantar extends ResourceController
{
    /**
    ...
    public function __construct()
    {
        ...
        $this->model = new KeteranganPengantarModel();
    ...
    {   
        ...
        return view('Backend/Modul/Pelayanan/Lhu/Keterangan-sampel/index', $data);
    }
    /**
    ...
    public function list()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('Backend/Modul/Pelayanan/Lhu/Keterangan/_data', $data)
            ];
    ...
    public function new()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('Backend/Modul/Pelayanan/Lhu/Keterangan/_add', $data)
            ];
    ...
    public function edit($id = null)
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => view('Backend/Modul/Pelayanan/Lhu/Keterangan/_edit', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('Not Process');
