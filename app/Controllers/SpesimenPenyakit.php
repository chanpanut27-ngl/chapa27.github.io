...
class SpesimenPenyakit extends ResourceController
{
    /**
    ...
    {
         $data = ['param1' => $param1];
         return view('Backend/Modul/Pelayanan/Lhu/Spesimen-penyakit/index', $data);
    }
    ...
    public function list() 
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('Backend/Modul/Pelayanan/Lhu/Spesimen-penyakit/_data', $data)
            ];
