...
class KondisiLingkunganPengantar extends ResourceController
{
    /**
    ...
    {   
        ...
        return view('Backend/Modul/Pelayanan/Lab/Kondisi-lingkungan/index', $data);
    }
    ...
    public function list()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('Backend/Modul/Pelayanan/Lab/Kondisi-lingkungan/__data', $data)
            ];
    ...
    public function new()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('Backend/Modul/Pelayanan/Lab/Kondisi-lingkungan/__add', $data)
            ];
    ...
    public function edit($id = null)
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => view('Backend/Modul/Pelayanan/Lab/Kondisi-lingkungan/__edit', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('Not Process');
