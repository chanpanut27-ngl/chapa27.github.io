...
class InstalasiMaster extends ResourceController
{
    /**
    ...
    public function list()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('Backend/Master/Instalasi/_data', $data)
            ];
    ...
    public function new()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('Backend/Master/Instalasi/_add', $data)
            ];
    ...
    public function edit($id = null)
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => view('Backend/Master/Instalasi/_edit', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('Not Process');
