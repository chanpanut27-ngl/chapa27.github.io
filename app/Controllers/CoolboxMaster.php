...
class CoolboxMaster extends BaseController
{
    ...
    public function list()
    {
        ...
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('Backend/Master/Coolbox/__data', $data)
            ];
    ...
    public function new()
    {
        if ($this->request->isAJAX()) {
            $data = [
                ...
                'masterInstansi' => $this->m_instansi->get_data()
            ];
            $msg = [
                'data' => view('Backend/Master/Coolbox/__add', $data)
            ];
    ...
    public function create()
    {
        if ($this->request->isAJAX()) {
            ...
            if (!$valid) {
                ...
                $save = [
                    'kode_coolbox' => $this->model->generate_kode($id_instansi),
                    'id_instansi' => $this->request->getVar('id_instansi'),
    ...
    public function edit($id = null)
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => view('Backend/Master/Coolbox/__edit', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('Not Process');
