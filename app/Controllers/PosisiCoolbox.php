...
class PosisiCoolbox extends BaseController
{
    /**
    ...
    public function list()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('Backend/Modul/Coolbox/__data', $data)
            ];
    ...
    public function new()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('Backend/Modul/Coolbox/__add', $data)
            ];
    ...
    public function edit($id = null)
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => view('Backend/Modul/Coolbox/__edit', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('Not Process');
