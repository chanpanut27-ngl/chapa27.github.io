        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('master-data/penyakit/create-data'); ?>" class="form-data">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary btn-sm rounded btn-simpan"><i class="ti ti-save"></i> Simpan</button>
...
<script src="<?= base_url('assets/js/Master/@save_penyakit.js') ?>"></script>
