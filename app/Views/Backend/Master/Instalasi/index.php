            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header p-2">
                        <h4><span class="pc-micon"><span class="fa-solid fa-list"></span> <?= $title; ?></h4>
...
<script>
    function listData() {
        $.ajax({
            url: "<?= site_url('master-data/instalasi/list-data'); ?>",
            dataType: 'json',
            cache: false,
            beforeSend: function() {
    ...
    $(document).ready(function() {
        ...
        $(".btn-tambah").click(function(e) {
            e.preventDefault();
            $.ajax({
                url: "<?= site_url('master-data/instalasi/add-data'); ?>",
                dataType: 'json',
                cache: false,
                beforeSend: function() {
