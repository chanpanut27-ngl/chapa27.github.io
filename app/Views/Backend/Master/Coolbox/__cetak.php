    ...
    <!-- <div class="row">
        <div class="col-md-4"> -->
            ...
            <div class="label-container">
                ...
                <p style="font-family: monospace; font-weight:bold; text-align: center; font-size: 8pt;">Tgl & Jam : <?= date('d/m/Y', strtotime($rows['tanggal'])).' '.date('H:i', strtotime($rows['jam'])); ?></p>
                ...
                ?>
                <img src="<?= esc($qrcode) ?>" alt="QR Code" style="width: 50px;">
            </div>
            <?php endforeach;?>
        <!-- </div>
    </div> -->
