            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header p-2">
                        <h4 style="font-family: arial;"><span class="pc-micon"><i class="ti ti-list"></i> <?= $title; ?></h4>
...
<script>
    function listData() {
        $.ajax({
            url: "<?= site_url('master-data/kategori-laboratorium/list-data'); ?>",
            dataType: 'json',
            cache: false,
            beforeSend: function() {
    ...
    $(document).ready(function() {
        ...
        $(".btn-tambah").click(function(e) {
            e.preventDefault();
            $.ajax({
                url: "<?= site_url('master-data/kategori-laboratorium/add-data'); ?>",
                dataType: 'json',
                cache: false,
                beforeSend: function() {
