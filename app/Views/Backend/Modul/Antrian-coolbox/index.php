        ...
        <div class="page-header">
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript: void(0)"><span class="badge rounded-pill bg-dark">Coolbox</span></a></li>
...
<script>
    function listData() {
        $.ajax({
            url: "<?= site_url('coolbox/antrian-coolbox/list-data'); ?>",
            dataType: 'json',
            cache: false,
            beforeSend: function() {
    ...
    $(document).ready(function() {
        ...
        $(".btn-tambah").click(function(e) {
            e.preventDefault();
            $.ajax({
                url: "<?= site_url('coolbox/antrian-coolbox/add-data'); ?>",
                dataType: 'json',
                cache: false,
                beforeSend: function() {
