...
<script>
    function listData() {
        ...
        $.ajax({
            url: "<?= site_url('pelayanan-pemeriksaan/kondisi-lingkungan-sekitar-sampel/list-data'); ?>",
            dataType: 'json',
            data:{
                 id_lab:id_lab,
    ...
    $(document).ready(function() {
        ...
        $(".btn-tambah").click(function(e) {
            e.preventDefault();
            $.ajax({
                url: "<?= site_url('pelayanan-pemeriksaan/kondisi-lingkungan-sekitar-sampel/add-data'); ?>",
                dataType: 'json',
                data:{
                 id_lab:id_lab,
                 kode_pengantar:kode_pengantar
