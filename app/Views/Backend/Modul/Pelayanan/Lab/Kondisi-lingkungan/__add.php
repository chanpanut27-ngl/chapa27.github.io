    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><i class="ti ti-square-plus fs-2"></i> <?= $title; ?></h5>
            ...
            ?>
            <form action="<?= base_url('pelayanan/pengantar-lab/kondisi-lingkungan/create-data'); ?>" class="form-data">
                <?= csrf_field(); ?>
...
<script src="<?= base_url('assets/js/Pelayanan/@save_koling_plab.js') ?>"></script>
