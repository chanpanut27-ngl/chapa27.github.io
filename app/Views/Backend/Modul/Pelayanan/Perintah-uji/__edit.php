                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-9 d-flex">
                            ...
                            <input type="hidden" name="tgl_terima_sampel" value="<?= date('d-m-Y', strtotime($search['tgl_terima_sampel'])) ?>" class="form-control" readonly id="tgl-terima">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body text-secondary">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <input type="date" name="tgl_kirim_sampel" value="<?= $search['tgl_kirim_sampel'] ?>" id="tgl-kirim-sampel" class="form-control" autocomplete="off">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body text-secondary">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <input type="date" name="tgl_selesai_sampel" value="<?= $search['tgl_selesai_sampel'] ?>" id="tgl-selesai-sampel" class="form-control" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                            </div>
