            ...
            <form action="<?= base_url('coolbox/posisi-coolbox/create-data'); ?>" class="form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="tanggal" class="form-control w-50" id="tanggal" autocomplete="off">
                        <div class="invalid-feedback errorTanggal"></div>
                    </div>
                    <div class="mb-3">
                        <label for="jam" class="form-label h5">Jam</label>
                        <input type="time" name="jam" class="form-control w-50" id="jam" autocomplete="off">
